...
function zilla_general_settings(){
    ...
    $general_settings[] = array('title' => __('Default Blog Page Title', 'zilla'),
                                'desc' => __('Please enter a default blog page title to be used.', 'zilla'),
                                'type' => 'text',
                                'id' => 'general_default_page_title');

    $general_settings[] = array('title' => __('Default Blog Page Caption', 'zilla'),
                            'desc' => __('Please enter a default blog page caption to be used.', 'zilla'),
                            'type' => 'text',
